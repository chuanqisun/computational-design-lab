...
{{#if requiredList}}
Analyze the provided item and assign an arousal level to each of the following moods: {{#each requiredList}}"{{this}}"{{#unless @last}}, {{/unless}}{{/each}}.
...
{
  "instruction": [
    "Analyze this shampoo packaging concept for the required moods and arousal levels."
  ],
  "requiredList": [
    "Calm",
    "Restorative",
